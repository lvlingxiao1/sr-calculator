		...
		<>
			...
			<div>
				<div>
					...
					<input
						type="number"
						onChange={(e) => 设置面板攻击力(+e.target.value)}
						value={面板攻击力}
					></input>
					&nbsp;&nbsp;&nbsp;(基础攻击力
					<input
						type="number"
						onChange={(e) => 设置基础攻击力(+e.target.value)}
						value={基础攻击力}
					></input>
					)
				</div>
			...
			<div>
				...
				<input
					type="number"
					onChange={(e) => 设置伤害提高(+e.target.value)}
					value={伤害提高}
				></input>{' '}
				%
			</div>
			...
			<div>
				<div>
					...
					<input
						type="number"
						onChange={(e) => 设置暴击率(+e.target.value)}
						value={暴击率}
					></input>{' '}
					% &nbsp;&nbsp;&nbsp;暴击伤害
					<input
						type="number"
						onChange={(e) => 设置暴击伤害(+e.target.value)}
						value={暴击伤害}
					></input>{' '}
					%
				</div>
			...
			<div>
				<div>
					...
					<input
						type="number"
						onChange={(e) => 设置人物等级(+e.target.value)}
						value={人物等级}
					></input>
					&nbsp;&nbsp;&nbsp;怪物等级
					<input
						type="number"
						onChange={(e) => 设置怪物等级(+e.target.value)}
						value={怪物等级}
					></input>
					&nbsp;&nbsp;&nbsp;减防百分比
					<input
						type="number"
						onChange={(e) => 设置减防百分比(+e.target.value)}
						value={减防百分比}
					></input>{' '}
					%
				</div>
			...
			<div>
				<div>
					...
					<input
						type="number"
						onChange={(e) => 设置怪物抗性(+e.target.value)}
						value={怪物抗性}
					></input>{' '}
					% &nbsp;&nbsp;&nbsp;减抗
					<input
						type="number"
						onChange={(e) => 设置减抗(+e.target.value)}
						value={减抗}
					></input>{' '}
					%
				</div>
			...
			<div>
				<div>
					...
					<input
						type="number"
						onChange={(e) => 设置易伤(+e.target.value)}
						value={易伤}
					></input>{' '}
					%
				</div>
			...
			<div>
				<div>
					...
					<input
						type="number"
						onChange={(e) => 设置韧性减伤(+e.target.value)}
						value={韧性减伤}
					></input>{' '}
					%
				</div>
			...
			<div>
				...
				<input
					type="number"
					onChange={(e) => 设置速度(+e.target.value)}
					value={速度}
				></input>
			</div>
			<h4>倍率乘区</h4>
			<div>
				...
				<input
					type="number"
					onChange={(e) => 设置技能倍率(+e.target.value)}
					value={技能倍率}
				></input>
				%
			</div>
			...
			<h4>银狼加成</h4>
			<p>
				10级战技-10%抗性，10级终结技-45%防御力，10级天赋-8%防御力，额外能力3触发-3%抗性
			</p>
			<p>
				未植入新弱点：单段伤害期望{' '}
				{银狼加成下伤害期望.暴击伤害期望.toFixed(2)}, 提升
				{计算提升(
					银狼加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
			...
			<p>
				植入新弱点-20%抗性：单段伤害期望{' '}
				{银狼植入弱点加成下伤害期望.暴击伤害期望.toFixed(2)}, 提升
				{计算提升(
					银狼植入弱点加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
				%
			</p>
			<p>
				...
				{银狼植入量子弱点量子套加成下伤害期望.暴击伤害期望.toFixed(2)},
				提升
				{计算提升(
					银狼植入量子弱点量子套加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
				%
			</p>
			...
			<p>
				不记战技拉条的伤害提升：单段伤害期望{' '}
				{布洛妮娅加成下伤害期望.暴击伤害期望.toFixed(2)}, 提升
				{计算提升(
					布洛妮娅加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
			...
			<h4>停云加成</h4>
			<p>
				10级战技+50%攻击力并额外造成20%攻击的额外伤害（20%倍率，会被技能倍率稀释），10级终结技+50%增伤
			</p>
			<p>
				不计算额外伤害的伤害提升：单段伤害期望{' '}
				{停云加成下伤害期望.暴击伤害期望.toFixed(2)}, 提升
				{计算提升(
					停云加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
			...
			<p>
				...
				{停云输出角色为雷属性加成下伤害期望.暴击伤害期望.toFixed(2)},
				提升
				{计算提升(
					停云输出角色为雷属性加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
				%
			</p>
			<h4>艾斯妲加成</h4>
			<p>
				10级天赋满层+70%攻击力，10级终结技+50速度，额外能力2
				+18%火属性伤害
			</p>
			<p>
				满层时非火系输出的伤害提升：单段伤害期望{' '}
				{艾斯妲加成下伤害期望.暴击伤害期望.toFixed(2)}, 提升
				{计算提升(
					艾斯妲加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
			...
			<p>
				轮均伤害提升：轮均期待伤害{' '}
				{艾斯妲加成下伤害期望.轮均期待伤害.toFixed(2)}, 提升
				{计算提升(
					艾斯妲加成下伤害期望.轮均期待伤害,
					单人伤害.轮均期待伤害
				)}
			...
			<p>
				满层时火系输出的伤害提升：单段伤害期望{' '}
				{艾斯妲输出角色为火属性加成下伤害期望.暴击伤害期望.toFixed(2)},
				提升
				{计算提升(
					艾斯妲输出角色为火属性加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
				%
			</p>
			<p>
				轮均伤害提升：轮均期待伤害{' '}
				{艾斯妲输出角色为火属性加成下伤害期望.轮均期待伤害.toFixed(2)},
				提升
				{计算提升(
					艾斯妲输出角色为火属性加成下伤害期望.轮均期待伤害,
					单人伤害.轮均期待伤害
				)}
				%
			</p>
			<h4>驭空加成</h4>
			<p>
				10级战技+80%攻击力，10级终结技+28%暴击率+65%暴击伤害，额外能力2
				+12%虚数伤害
			</p>
			<p>
				非虚数系输出的伤害提升：单段伤害期望{' '}
				{驭空加成下伤害期望.暴击伤害期望.toFixed(2)}, 提升
				{计算提升(
					驭空加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
			...
			<p>
				虚数系输出的伤害提升：单段伤害期望{' '}
				{驭空输出角色为虚数属性加成下伤害期望.暴击伤害期望.toFixed(2)},
				提升
				{计算提升(
					驭空输出角色为虚数属性加成下伤害期望.暴击伤害期望,
					单人伤害.暴击伤害期望
				)}
				%
			</p>
